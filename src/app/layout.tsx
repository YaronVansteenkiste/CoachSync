    ...
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="antialiased bg-dark text-white">
        ...
        <div className={showNavBar ? (isMobile ? "w-full bg-dark mb-44 p-4" : "ml-48 children-container flex flex-col p-10 min-h-screen") : "w-full bg-dark p-4"}>
            ...
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500 opacity-30 rounded-full blur-3xl z-[-1]"></div>
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-purple-500 opacity-30 rounded-full blur-3xl z-[-1]"></div>
        <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-red-500 opacity-30 rounded-full blur-3xl z-[-1]"></div>
        </div>
